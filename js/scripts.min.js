...
$(document).ready(function(){$(".sliderr").slick({infinite:!0,speed:700,slidesToShow:1,centerMode:!0,centerPadding:"20px",adaptiveHeight:!0,responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1,infinite:!0}},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]}),HeartsBackground.initialize(),setTimeout(function(){$(".preloader").fadeOut(1e3)},5e3);var t=document.getElementById("music"),e=document.getElementsByClassName("pausee"),i=document.getElementsByClassName("stopee"),s=document.getElementsByClassName("playy");$(e).click(function(){t.pause()}),$(i).click(function(){t.pause(),t.currentTime=0}),$(s).click(function(){t.play()})});var HeartsBackground={heartHeight:60,heartWidth:64,hearts:[],heartImage:"http://i58.tinypic.com/ntnw5.png",maxHearts:20,minScale:.4,draw:function(){this.setCanvasSize(),this.ctx.clearRect(0,0,this.w,this.h);for(var t=0;t<this.hearts.length;t++){var e=this.hearts[t];e.image=new Image,e.image.style.height=e.height,e.image.src=this.heartImage,this.ctx.globalAlpha=e.opacity,this.ctx.drawImage(e.image,e.x,e.y,e.width,e.height)}this.move()},move:function(){for(var t=0;t<this.hearts.length;t++){var e=this.hearts[t];e.y+=e.ys,e.y>this.h&&(e.x=Math.random()*this.w,e.y=-1*this.heartHeight)}},setCanvasSize:function(){this.canvas.width=window.innerWidth,this.canvas.height=window.innerHeight,this.w=this.canvas.width,this.h=this.canvas.height},initialize:function(){if(this.canvas=$("#canvas")[0],this.canvas.getContext){this.setCanvasSize(),this.ctx=this.canvas.getContext("2d");for(var t=0;t<this.maxHearts;t++){var e=Math.random()*(1-this.minScale)+this.minScale;this.hearts.push({x:Math.random()*this.w,y:Math.random()*this.h,ys:Math.random()+1,height:e*this.heartHeight,width:e*this.heartWidth,opacity:e})}setInterval($.proxy(this.draw,this),30)}}};